...
def get_word_score(word, n):
    ...
    for i in word:
        TotalScore += SCRABBLE_LETTER_VALUES[i]
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:
        print "Current Hand:"
        display_hand(hand)
        tryWord = str(raw_input("Enter word, or a '.' to indicate that you are finished:")).lower()
        if tryWord == '.':
            break
